...
5. launch sub-agent review if the task spans multiple components
...
- If emergent decisions exist, replace stale plan content with the as-built slice.
  Commit as: `docs(<workspace>): align I<N> and S<N> plans with as-built slice`
